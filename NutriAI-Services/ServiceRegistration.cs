    ...
    public static class ServiceRegistration
    {
        public static void AddProjectServices(this IServiceCollection services, IConfiguration? configuration = null)
        {
            ...
            var types = assembly.GetTypes()
                ...
                .Where(t => t != typeof(AuthService) && t != typeof(MasterDataService) && t != typeof(IngredienteService) && t != typeof(UsuarioService) && t != typeof(PerfilService)) // Exclude manually registered services
                .Select(t => new
                {
